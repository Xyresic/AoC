...
i = open('../inputs/input7.txt', 'r').readlines()
...
class NotGate(Component):
    ...
    def send_signal(self):
        self.outputs[0].output = np.uint16(~ self.inputs[0].output)
...
class LShiftGate(Component):
    ...
    def send_signal(self):
        self.outputs[0].output = np.uint16(self.inputs[0].output << self.shift)
...
class AndGate(Component):
    ...
    def send_signal(self):
        self.outputs[0].output = np.uint16(self.inputs[0].output & self.inputs[1].output)
